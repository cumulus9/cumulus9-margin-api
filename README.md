...
| `risk_free_rate`              | `number`        | validated ETD rate, otherwise `0.01` | Optional portfolio-wide analytics override. When omitted, validated ETD options retain their maturity-matched rate |
