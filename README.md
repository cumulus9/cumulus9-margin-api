...
| --------- | ---- | ------- | ----------- |
| `portfolio` | `array` | *required* | Array of position objects (see [Position Types](#position-types)) |
...
| `additional_margin` | `number` | Add-on charges (liquidity, concentration, etc.) |
| `pnl` | `number` | P&L |
